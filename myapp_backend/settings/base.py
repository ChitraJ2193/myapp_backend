"""
Shared Django settings. Environment-specific files import from here.
"""
...
SECRET_KEY = config("SECRET_KEY", default="dev-only-change-me-in-production")
...
DATABASES = {
    "default": {
        ...
        "NAME": config("POSTGRES_DB", default="myapp_db"),
        "USER": config("POSTGRES_USER", default="myapp_user"),
        "PASSWORD": config("POSTGRES_PASSWORD", default="myapp_password"),
